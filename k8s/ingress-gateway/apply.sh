...
echo "   kubectl get svc -n ingress-gateway-ns"
echo ""
echo "🌐 Access the service:"
echo "   curl <node-ip>/backend/..."
echo "   # Within cluster: curl http://ingress-gateway.ingress-gateway-ns.svc.cluster.local/backend/..."
echo ""
echo "🔍 View logs:"
